...
public class RunnerResultGeneratorImpl implements RunnerResultGenerator {
	 ...
	 * 
	 * @see
	 * binky.reportrunner.engine.impl.RunnerResultGenerator#getResultsForJob
	 * (binky.reportrunner.data.RunnerJob, java.util.Map)
	 */
	 ...
	 * 
	 * @see
	 * binky.reportrunner.engine.impl.RunnerResultGenerator#renderReport(java
	 * .sql.ResultSet, java.lang.String, byte[],
	 * binky.reportrunner.data.RunnerJob.Template, java.lang.String)
	 */
	public void renderReport(ResultSet results, String label, String url,
