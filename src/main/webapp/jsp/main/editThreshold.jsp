...
<sj:tabbedpanel id="report" animate="true"  useSelectedTabCookie="true">	
		...
		<div id="detailsDiv" >
			<div class="formGroup">
				...
				<sx:div showLoadingText="true" loadingText="Testing query..." id="validateQuery" href="%{validateUrl}" theme="ajax"  listenTopics="refresh_fields" formId="saveThreshold">
				</sx:div>
...
<div>
		...
		<sj:tab id="configTab" target="configDiv" label="Threshold Configuration"/>
		<div id="configDiv" >
			<div class="formGroup">
				...
				<sx:div  showLoadingText="true" loadingText="Getting fields..." id="refreshFields" href="%{fieldsUrl}" theme="ajax"  listenTopics="refresh_fields" formId="saveThreshold">
				</sx:div>
